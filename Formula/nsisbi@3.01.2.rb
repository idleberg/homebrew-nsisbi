class NsisbiAT3012 < Formula
  desc "System to create big Windows installers"
  homepage "https://sourceforge.net/projects/nsisbi/"
  url "https://downloads.sourceforge.net/project/nsisbi/nsisbi3.01.2/nsis-code-6823-1-NSIS-trunk.zip"
  version "3.01.2"
  sha256 "df9d329e74cff9b4991098110a654886564406462bc092dfbaee9771f7b6a757"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsisbi/nsisbi3.01.2/nsis-binary-6823-1.zip"
    sha256 "6bbb7f9668d6a56f4e5179beb26bdebb94c34361459c86990f0603ead5961add"
  end
