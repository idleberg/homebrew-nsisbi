class NsisbiAT3041 < Formula
  desc "System to create big Windows installers"
  homepage "https://sourceforge.net/projects/nsisbi/"
  url "https://downloads.sourceforge.net/project/nsisbi/nsisbi3.04.1/nsis-code-7069-1-NSIS-trunk.zip"
  version "3.04.1"
  sha256 "cae697a3e74906068267890eb14787ab20a57f557c4b460b4dc14a6fb53fd25e"
  ...
  resource "nsis" do
    url "https://downloads.sourceforge.net/project/nsisbi/nsisbi3.04.1/nsis-binary-7069-1.zip"
    sha256 "21823151ef3eb5bb2745c12ed0655d83e84ee1404aedca31368229dfdfd824ab"
  end
